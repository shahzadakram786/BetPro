            ...
            <div className="relative bg-linear-to-b from-brand-blue-top to-brand-blue-bottom rounded-[3rem] p-12 border border-white/10 shadow-2xl overflow-hidden">
              ...
              <div className="flex justify-center mb-10">
                <div className="w-28 h-28 bg-[#70E1E1] rounded-full flex items-center justify-center shadow-[0_0_30px_rgba(112,225,225,0.3)]">
                  <span className="text-black text-5xl font-serif italic font-black">
                    BP
                  </span>
                </div>
              </div>
              ...
              <div className="flex justify-center">
                <a
                  ...
                  className="bg-linear-to-b from-brand-blue-light to-brand-blue-top text-white px-12 py-3 rounded-full font-bold shadow-[0_10px_20px_rgba(0,0,0,0.4),inset_0_1px_1px_rgba(255,255,255,0.2)] hover:scale-105 transition-transform active:scale-95"
                >
                  Login
                </a>
              </div>
